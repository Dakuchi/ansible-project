...
# Create EC2 instance for production server
...
output "ec2_public_ip_one" {value = aws_instance.myapp-server-one.public_ip}
output "ec2_public_ip_two" {value = aws_instance.myapp-server-two.public_ip}